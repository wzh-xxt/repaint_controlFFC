...
from guided_diffusion.modules.utils import LinearRamp
...
def make_random_irregular_mask(shape, max_angle=4, max_len=200, max_width=100, min_times=1, max_times=5,
...
class RandomIrregularMaskGenerator:
    def __init__(self, max_angle=4, max_len=200, max_width=100, min_times=1, max_times=5, ramp_kwargs=None,
                 draw_method=DrawMethod.LINE):
...
class RandomRectangleMaskGenerator:
    def __init__(self, margin=10, bbox_min_size=30, bbox_max_size=150, min_times=1, max_times=4, ramp_kwargs=None):
        self.margin = margin
