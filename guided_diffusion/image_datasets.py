...
from guided_diffusion.mask import *
...
class ImageDatasetTrain(Dataset):
    def __init__(
        ...
        gt_paths = sorted(gt_paths)[:offset-1]
        ...
        self.mask_generator = MixedMaskGenerator()
    ...
    def __getitem__(self, idx):
        ...
        mask = self.mask_generator(np.transpose(arr_gt, [2, 0, 1]))
        ...
        return np.transpose(arr_gt, [2, 0, 1]),mask.astype(np.float32)
...
class ImageDatasetInpa(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask_path = self.local_masks[idx % len(self.local_masks)]
